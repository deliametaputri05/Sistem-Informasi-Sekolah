...
<section class="contact">
    <div class="container">
        ...
        <div class="row" >
            <div class="col-md-12" >
                <div class="contact-form" style="background-color: #44B044">
                    <div class="row">
                            ...
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <p> SMP NU Losarang
                                        ...
                                        <br> Jl Raya Desa Santing, Losarang Indramayu</p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h6>Email</h6>
                                        <p>smpnulos@gmail.com
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="contact-center" style="background-color: #309430" >OR</p>
                </div>
            </div>
        </div>
    </section>
