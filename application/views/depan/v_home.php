...
<head>
    ...
    <title>SMP NU LOSARANG  - Selamat Datang di SMP NU LOSARANG </title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/slide4.png'?>" alt="First slide" width=100px>
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/slide5.png'?>" alt="Second slide" width=100px>
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/slide3.png'?>" alt="Third slide" width=100px>
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Kami Menyambut baik terbitnya Website SMP NU Losarang yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>

            </div>
            <div class="col-md-4">
                <img src="<?php echo base_url().'theme/images/agung.jpeg'?>" class="img-fluid about-img" alt="#">
            </div>
        </div>
    </div>
</section>
...
<!--//END EVENTS -->
<!--============================= DETAILED CHART =============================-->
<div class="detailed_chart" style="background-image: url(theme/images/smpnu.png); ">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 chart_top">
                ...
                <div class="chart-text">
                    <p><span class="counter"><?php echo $tot_files;?></span> Ebook
                    </p>
                </div>
            </div>
